...
class TrajectoryClient:
    ...
    def send_cartesian_trajectory(self):
        ...
        pose_list = [
            ...
            geometry_msgs.Pose(
                geometry_msgs.Vector3(0.5, 0.3, 0.6), geometry_msgs.Quaternion(0, 0, 0, 1)
            ),
        ]
    ...
    def send_cartesian_trajectory2(self):
        """Creates a Cartesian trajectory and sends it using the selected action server"""
        self.switch_controller(self.cartesian_trajectory_controller)
        ...
        pose_list = [
            geometry_msgs.Pose(
                geometry_msgs.Vector3(0.2, -0.05, 0.2), geometry_msgs.Quaternion(0, 0, 0, 1)
            ),
            geometry_msgs.Pose(
                geometry_msgs.Vector3(0.2, 0.1, 0.3), geometry_msgs.Quaternion(0, 0, 0, 1)
            ),
            geometry_msgs.Pose(
                geometry_msgs.Vector3(0.2, 0.1, 0.2), geometry_msgs.Quaternion(0, 0, 0, 1)
            ),
            geometry_msgs.Pose(
                geometry_msgs.Vector3(0.2, -0.05, 0.2), geometry_msgs.Quaternion(0, 0, 0, 1)
            ),
...
if __name__ == "__main__":
    ...
    client.send_cartesian_trajectory2()
